  ...
  <main class="auth-page">
    <section class="auth-card">
      <a class="auth-brand" href="index.html"><span class="brand-icon"><i class="bi bi-grid-1x2-fill"
            aria-hidden="true"></i></span><span><strong>Admin Dashboard</strong><small>Sign in to your admin
    ...
    <!-- *********** Message to display when user login is invalid************** -->
      ...
      <form method="post" action="<?= base_url('/admin/auth/login') ?>">
        ...
        <div class="mb-3">
          ...
          <input class="form-control" id="loginPassword" type="password" minlength="6" name="password" required>
